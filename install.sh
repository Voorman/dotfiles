...
######################################################################
# 🧰 Voorman/Dotfiles - All-in-One Install and Setup Script for Unix #
######################################################################
...
#   DOTFILES_REPO: Git repo to USE (default: Voorman/Dotfiles)       #
#                                                                    #
...
REPO_NAME="${REPO_NAME:-Voorman/Dotfiles}"
